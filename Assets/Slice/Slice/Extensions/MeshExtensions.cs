...
namespace BLINDED_AM_ME.Extensions
{
    public static class MeshExtensions
    {
        ...
        public static Tuple<Mesh, Mesh> Cut(this Mesh mesh, Plane blade, int capSubMeshIndex = 0,
        ...
        public static IEnumerator CutCoroutine(this Mesh mesh, Plane blade, Action<Tuple<Mesh, Mesh>> callback,
            int capSubMeshIndex = 0, CancellationToken cancellationToken = default)
        {
            // this has to be done on UI thread
            var maker = mesh.ToMeshMaker();
        ...
        private static async Task<Tuple<MeshMaker, MeshMaker>> CutTaskAsync(MeshMaker sourceMesh, Plane blade,
            int capSubMeshIndex = 0, CancellationToken cancellationToken = default)
        {
            ...
            foreach (var polygon in capPolygons)
            {
                ...
                var triangles =
                    await MathExtensions.Geometry.TriangulateNonConvexPolygonAsync(polygon2D, cancellationToken);
                ...
                for (int i = 0; i < triangles.Length; i += 3)
                {
                            ...
                            blade.normal))
                    {
                        ...
                        (index_1, index_3) = (index_3, index_1);
                    }
